...
# 参数解析 - mcp_logger.py 脚本内部使用argparse解析参数，
# 根据代码中的 parser.add_argument('command', nargs=argparse.REMAINDER, ...) ，
# python -m mcp_server_fetch 这三个参数会被当作要包装执行的命令
# argparse.REMAINDER 会将所有剩余参数都收集到 command 列表中
